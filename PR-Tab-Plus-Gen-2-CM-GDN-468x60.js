...
lib.ssMetadata = [
		{name:"PR_Tab_Plus_Gen_2_CM_GDN_468x60_atlas_1", frames: [[916,0,50,50],[0,0,468,60],[415,124,412,60],[0,124,413,60],[411,186,407,60],[0,62,431,60],[433,62,417,60],[0,186,409,60],[382,248,407,56],[0,248,380,60],[470,0,444,60],[968,0,20,60]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Tab_Plus_Gen_2_CM_GDN_468x60_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRTabPlusGen2CMGDN468x60 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(399).to({_off:false},0).to({y:10.45},12).wait(19));

	// clickTag_btn
	this.clickTag_btn = new lib.clickTag_btn();
	this.clickTag_btn.name = "clickTag_btn";
	this.clickTag_btn.setTransform(234,30,0.6429,0.6667,0,0,0,364,45);
	...
	this.instance.setTransform(448,0);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(399).to({_off:false},0).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(350).to({_off:false},0).to({_off:true},49).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(299).to({_off:false},0).to({_off:true},51).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(249).to({_off:false},0).to({_off:true},50).wait(131));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(200).to({_off:false},0).to({_off:true},49).wait(181));

	// F4
	this.instance_6 = new lib.F4();
	this.instance_6.setTransform(20,0);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(150).to({_off:false},0).to({_off:true},50).wait(230));

	// F3
	this.instance_7 = new lib.F3();
	this.instance_7.setTransform(21,0);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(99).to({_off:false},0).to({_off:true},51).wait(280));

	// F2
	this.instance_8 = new lib.F2();
	this.instance_8.setTransform(21,0);
	...
	this.instance_9.setTransform(21,0);
...
p.nominalBounds = new cjs.Rectangle(234,14.5,234,45.5);
// library properties:
lib.properties = {
	id: '565E72C7086A4642A1821720C8ADD9C1',
	width: 468,
	height: 60,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Tab_Plus_Gen_2_CM_GDN_468x60_atlas_1.png", id:"PR_Tab_Plus_Gen_2_CM_GDN_468x60_atlas_1"}
	],
	preloads: []
};
...
an.compositions['565E72C7086A4642A1821720C8ADD9C1'] = {
